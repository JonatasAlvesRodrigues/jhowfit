    ...
    <div className="onboarding-shell">
      ...
      <div className="onboarding-layout">
        <aside className="onboarding-steps">
          <div className="onboarding-steps__intro"><small>SEU PERFIL</small><h2>Vamos personalizar o MOVELYA.</h2><p>Suas respostas ajudam a preparar uma experiência mais adequada à sua rotina.</p></div>
...
function SafetyStep({ data, update }: { data: OnboardingData; update: Update }) {
  ...
  return <div className="onboarding-stack">
    <div className="medical-notice"><ShieldAlert size={21} /><p><strong>Sua segurança é prioridade.</strong><span>O MOVELYA não substitui acompanhamento médico, nutricional, fisioterapêutico ou de um profissional de educação física. Consulte um profissional antes de iniciar mudanças relevantes.</span></p></div>
